...
'currentevents-url' => 'Wikipedia:Güncəl Hadisələr',
...
'sitesubtitle' => 'Açıq Ensiklopediya',
...
'readonlytext' => 'The database is currently locked to new entries and other modifications, probably for routine database maintenance, after which it will be back to normal. The administrator who locked it offered this explanation: $1',
...
'protectedtext' => 'This page has been locked to prevent editing; there are a number of reasons why this may be so, please see [[Project:Protected page]].
...
'blockedtext' => '__NOEDITSECTION__
{|style="margin: 0 2%; padding: 0 7px 7px 7px; background: #FEE; border: 1px solid #999999; text-align: left; width: 96%;"
|width="40px"|[[Image:Stop_hand.png|left|38px]]
|<big>\'\'\'Sizin istifadəçi adınız və ya IP unvanınız  $1 vasitəsiyla bloke edilib.\'\'\'</big>
|}

\'\'\'Dəlili budur\'\'\':<br />\'\'$2\'\'<p>  Siz $1 yada başqa idarəçilərilə [[Project:İdarəçilər |idarəçilər]] ilə təmas tutub bu bloke olmaği muzakirə edə bilərsiz.<br><br>

Diqqət edin ki e-məktub imkanindan özünüz e-məktub verməyincə istifadə edənməsiz.
[[Special:Preferences|Tərcihlər]].<br>

Sizin IP unvanınız $3 dur. Lütfən bu IP unvani öz məktublarınızda qeyd edin.',
...
'session_fail_preview' => '<strong>Sorry! We could not process your edit due to a loss of session data. Please try again. If it still doesn\'t work, try logging out and logging back in.</strong>',
...
press "Save page".<br />',
'yourtext' => 'Metniniz ',
'editingold' => '<strong>WARNING: You are editing an out-of-date revision of this page. If you save it, any changes made since this revision will be lost.</strong>',
'yourdiff' => 'Fərqlər ',
'copyrightwarning' => '<div class="plainlinks" align="center" style="margin-top:10px; border-width:1px; border-style:solid; border-color:#aaaaaa; padding:3px; background-color:#FFFFFF;">  
<font size="+1"> 
<charinsert>Ə ə</charinsert> · 
<charinsert>Ç ç</charinsert> · 
<charinsert>Ğ ğ</charinsert> ·
<charinsert>İ ı</charinsert> ·
<charinsert>Ö ö</charinsert> ·
...
'longpagewarning' => '<strong>WARNING: This page is $1 kilobytes long; some browsers may have problems editing pages approaching or longer than 32kb. Please consider breaking the page into smaller sections.</strong>',
...
'powersearch' => 'Axtar',
'powersearchtext' => 'Search in namespaces :<br /> $1<br /> $2 List redirects &nbsp; Search for $3 $9',
...
'showhideminor' => 'Kiçik redaktələri $1 | Bot redaktələrini $2 | İstifadəçi adı altında edilən redaktələri $3 | Nəzarət edilən redaktələri $4',
...
'excontentauthor' => 'content was: \'$1\' (and the only contributor was \'[[User:$2|$2]]\')',
...
'revertpage' => 'Reverted edit of [[User:$2|$2]], changed back to last version by [[User:$1|$1]]',
'protectlogpage' => 'Protection_log',
'protectlogtext' => 'Below is a list of page locks/unlocks. See [[Project:Protected page]] for more information.',
...
'blockiptext' => 'Use the form below to block write access from a specific IP address or username. This should be done only only to prevent vandalism, and in accordance with [[Project:Policy|policy]]. Fill in a specific reason below (for example, citing particular pages that were vandalized).',
...
'blocklogtext' => 'This is a log of user blocking and unblocking actions. Automatically blocked IP addresses are not listed. See the [[Special:Ipblocklist|IP block list]] for the list of currently operational bans and blocks.',
